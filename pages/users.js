...
const rows = [
  createData("Admin", "Frozen yoghurt", "Customer"),
  createData("XXX", "Gunther", "Employeer"),
  createData("YYY", "Gupta", "Customer"),
  createData("ZZZ", "Singh", "Customer"),
  createData("KKK", "Gawel", "Customer"),
]
    ...
    <div>
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog} fullWidth maxWidth={'md'}>
        ...
        <DialogContent>
          ...
          <TextField margin="dense" label="Username" style={{width: 400, marginRight: 20}}/>
      ...
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
            ...
            <Button onClick={handleOpenDialog} variant="contained">Add user</Button>
          </Stack>
        </Grid>
        <Grid item xs={12}>
